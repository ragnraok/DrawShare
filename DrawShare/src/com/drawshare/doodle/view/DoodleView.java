package com.drawshare.doodle.view;
...
import com.drawshare.doodle.action.TextAction;
...
//						Log.d(LOG_TAG, "move to " + x + ", " + y);
	...
	public void addTextAction( String text ){
		curAction = new TextAction( text, DEFAULT_TEXT_SIZE, this.color, getWidth()/2, getHeight()/2);
		invalidate();
